...
def dasked_download(img_url, dest):
    ...
    try:
        name = img_url.get_attribute("alt").replace(" ", "_")
...
def __scroll_down_page(wd, speed=7):
...
if __name__ == "__main__":
    ...
    driver.get(f'https://eyecatchingcoral.com/aquaculture/aquacultured-frags/')

    __scroll_down_page(driver)

    output_path = f'./ecc/frags/'
